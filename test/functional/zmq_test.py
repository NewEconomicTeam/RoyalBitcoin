...
from test_framework.test_framework import RoyalbitcoinTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (RoyalbitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that royalbitcoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("royalbitcoind has not been built with zmq enabled.")
