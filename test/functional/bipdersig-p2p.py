...
class BIP66Test(RoyalbitcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # royalbitcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and royalbitcoind produces more specific reject
            # reasons.
