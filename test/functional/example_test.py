...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the RoyalbitcoinTestFramework
    pass

class ExampleTest(RoyalbitcoinTestFramework):
    # Each functional test is a subclass of the RoyalbitcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        RoyalbitcoinTestFramework class so other tests can use it."""
