...
- #6932 `73fa5e6` ModifyRoyalBitcoins saves database lookups (Alex Morcos)
...
- #7209 `f3ad812` test: don't override ROYALBITCOIND and ROYALBITCOINCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add ROYALBITCOIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
...
- #6504 `b6fee6b` Rationalize currency unit to "RBTC" (Ross Nicoll)
