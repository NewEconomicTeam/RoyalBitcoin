...
#ifndef ROYALBITCOIN_WALLET_WALLET_H
#define ROYALBITCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this royalbitcoin node, and set to 0 for transactions that were created
...
#endif // ROYALBITCOIN_WALLET_WALLET_H
