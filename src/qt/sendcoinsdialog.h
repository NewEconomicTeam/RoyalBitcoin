...
#ifndef ROYALBITCOIN_QT_SENDCOINSDIALOG_H
#define ROYALBITCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending royalbitcoins */
...
#endif // ROYALBITCOIN_QT_SENDCOINSDIALOG_H
