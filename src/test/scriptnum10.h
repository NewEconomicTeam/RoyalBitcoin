...
#ifndef ROYALBITCOIN_TEST_SCRIPTNUM10_H
#define ROYALBITCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Royalbitcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ROYALBITCOIN_TEST_BIGNUM_H
