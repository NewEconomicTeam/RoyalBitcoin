...
{
    BOOST_CHECK(TestSplitHost("www.royalbitcoin.org", "www.royalbitcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.royalbitcoin.org]", "www.royalbitcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.royalbitcoin.org:80", "www.royalbitcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.royalbitcoin.org]:80", "www.royalbitcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:10333", "127.0.0.1", 10333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:10333", "127.0.0.1", 10333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:10333", "::ffff:127.0.0.1", 10333));
    BOOST_CHECK(TestSplitHost("[::]:10333", "::", 10333));
    BOOST_CHECK(TestSplitHost("::10333", "::10333", -1));
    BOOST_CHECK(TestSplitHost(":10333", "", 10333));
    BOOST_CHECK(TestSplitHost("[]:10333", "", 10333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:10333", "127.0.0.1:10333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:10333", "[::]:10333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
