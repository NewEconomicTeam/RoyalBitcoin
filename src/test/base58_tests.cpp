...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CRoyalbitcoinSecret::SetString tests isValid, whereas CRoyalbitcoinAddress does not!
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_gen)
{
    ...
    CRoyalbitcoinAddress dummyAddr;
